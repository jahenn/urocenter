...
<h4 class="heading-1 clearfix">
    <div class="heading-content">
        <?php echo __('Exam Categories'); ?>        <!-- <small>
...
<div class="row">
				...
				<tr>
					<th colspan="3" class="text-left pad5A">
						<div class="button-group">
							<?php echo $this->Html->link(__('New Exam Category'), array('action' => 'add'), array(
	...
	<tr>
		<td><?php echo h($examCategory['ExamCategory']['id']); ?>&nbsp;</td>
		<td><?php echo h($examCategory['ExamCategory']['nombre']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('<i class="fa fa-eye"></i>  View'), array('action' => 'view', $examCategory['ExamCategory']['id']), array('class'=>'btn medium primary-bg', 'escape'=>false)); ?>
			<?php echo $this->Html->link(__('<i class="fa fa-edit"></i> Edit'), array('action' => 'edit', $examCategory['ExamCategory']['id']),array('class'=>'btn medium primary-bg', 'escape'=>false)); ?>
			<?php echo $this->Form->postLink(__('<i class="fa fa-times"></i> Delete'), array('action' => 'delete', $examCategory['ExamCategory']['id']), array('class'=>'btn medium primary-bg', 'escape'=>false), __('Are you sure you want to delete # %s?', $examCategory['ExamCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
		<tr>
