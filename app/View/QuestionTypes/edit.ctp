...
<h4 class="heading-1 clearfix">
	<div class="heading-content">
		<?php echo __('Edit Question Type'); ?>       	       
    	<!-- <small>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QuestionType.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('QuestionType.id'))); ?></li>
