...
<div class="related">
	...
	<?php foreach ($questions as $question): ?>
		<tr>
			<td class="text-center"><?php echo $question['Question']['question']; ?></td>
				...
				<div class="dropdown">
				  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
						...
						<li role="presentation">
							<?= $this->Form->postLink(__('Eliminar'), array('controller' => 'questions', 'action' => 'delete', $question['Question']['id']), array(
								'role'=>'menuitem',
								'tabindex'=>'-1'
							), __('Estas seguro de eliminar la pregunta?', $question['Question']['id'])) ?>
						</li>
