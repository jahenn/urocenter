<div class="userExams index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $userExam['UserExam']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $userExam['UserExam']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userExam['UserExam']['id']), array(), __('Are you sure you want to delete # %s?', $userExam['UserExam']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
